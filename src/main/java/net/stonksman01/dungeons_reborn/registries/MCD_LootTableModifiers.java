...
public class MCD_LootTableModifiers {
    ...
    public static void modifyLootTables() {
        LootTableEvents.MODIFY.register(((registryKey, builder, lootTableSource, wrapperLookup) -> {
            modifyChestLootTable(registryKey, builder, LootTables.WOODLAND_MANSION_CHEST, MCD_Items.AUTO_CROSSBOW, 1, 0.01f);
            modifyChestLootTable(registryKey, builder, LootTables.WOODLAND_MANSION_CHEST, MCD_Blocks.MIDNIGHT_MOSS_BLOCK, 1, 0.1f);
            modifyChestLootTable(registryKey, builder, LootTables.JUNGLE_TEMPLE_CHEST, MCD_Items.TWIN_BOW, 1, 0.1f);
            modifyChestLootTable(registryKey, builder, LootTables.SIMPLE_DUNGEON_CHEST, MCD_Items.ROUGH_DIAMOND_SWORD, 1, 0.02f);
            modifyChestLootTable(registryKey, builder, LootTables.PILLAGER_OUTPOST_CHEST, MCD_Items.STEEL_MACE, 1, 0.05f);
            modifyChestLootTables(registryKey, builder, List.of(LootTables.WOODLAND_MANSION_CHEST, LootTables.PILLAGER_OUTPOST_CHEST), MCD_Items.ARTIFACT_IRON_HIDE_AMULET, 1, 0.1f);
