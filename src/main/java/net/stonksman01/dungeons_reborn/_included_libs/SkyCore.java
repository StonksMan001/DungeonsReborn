...
public class SkyCore {
    ...
    public static class BuiltinRegistries {
        ...
        public static Block registerBlock(String name, Function<AbstractBlock.Settings, Block> factory, AbstractBlock.Settings settings) {
            return registerBlock(RegistryKey.of(RegistryKeys.BLOCK, identifierOfDungeonsReborn(name)), factory, settings);
        }
        ...
        public static Item registerItem(String name, Function<Item.Settings, Item> factory) {
            return registerItem(RegistryKey.of(RegistryKeys.ITEM, identifierOfDungeonsReborn(name)), factory, new Item.Settings());
        }

        public static Item registerItem(String name, Function<Item.Settings, Item> factory, Item.Settings settings) {
            return registerItem(RegistryKey.of(RegistryKeys.ITEM, identifierOfDungeonsReborn(name)), factory, settings);
        }
        public static Item registerItem(String name, Item.Settings settings) {
            return registerItem(RegistryKey.of(RegistryKeys.ITEM, identifierOfDungeonsReborn(name)), Item::new, settings);
        }

        public static Item registerItem(String name) {
            return registerItem(RegistryKey.of(RegistryKeys.ITEM, identifierOfDungeonsReborn(name)), Item::new, new Item.Settings());
        }
        public static Item registerItem(RegistryKey<Item> key, Function<Item.Settings, Item> factory) {
            return registerItem(key, factory, new Item.Settings());
        }
        ...
        public static Block registerBlockAndItem(String name, Function<AbstractBlock.Settings, Block> factory, AbstractBlock.Settings settings) {
            Block block = factory.apply(settings.registryKey(RegistryKey.of(RegistryKeys.BLOCK, identifierOfDungeonsReborn(name))));
            registerBlockItem(name, block);
            return Registry.register(Registries.BLOCK, identifierOfDungeonsReborn(name), block);
        }
        public static Block registerBlockAndItem(String name, AbstractBlock.Settings settings) {
            return registerBlockAndItem(name, Block::new, settings);
        }
        private static void registerBlockItem(String name, Block block) {
            Registry.register(Registries.ITEM, identifierOfDungeonsReborn(name),
