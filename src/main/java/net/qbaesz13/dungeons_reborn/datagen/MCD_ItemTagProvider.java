...
public class MCD_ItemTagProvider extends FabricTagsProvider.ItemTagsProvider {
    public MCD_ItemTagProvider(FabricPackOutput output, CompletableFuture<HolderLookup.Provider> registryLookupFuture) {
